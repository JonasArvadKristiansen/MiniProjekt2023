...
INSERT INTO recipes(userId, title, instructions, personorstk, amount, dateCreated) VALUES (1, "Lemon cake", "bake it on 200degrade ovn", "person", 20, NOW(), "0");
INSERT INTO recipes(userId, title, instructions, personorstk, amount, dateCreated) VALUES (2, "Le cake", "bake it on 200degrade ovn", "person", 20,NOW(), "0");
INSERT INTO recipes(userId, title, instructions, personorstk, amount, dateCreated) VALUES (1, "L cake", "bake it on 200degrade ovn", "person", 20, NOW(), "0");
INSERT INTO recipes(userId, title, instructions, personorstk, amount, dateCreated) VALUES (1, "Leon cake", "bake it on 200degrade ovn", "person", 20, NOW(), "0");
INSERT INTO recipes(userId, title, instructions, personorstk, amount, dateCreated) VALUES (3, "Lem cake", "bake it on 200degrade ovn", "person", 20, NOW() "0");